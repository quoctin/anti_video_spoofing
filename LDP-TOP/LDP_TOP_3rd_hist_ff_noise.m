...
function hist = LDP_TOP_3rd_hist_ff_noise(data, width, height, nframe, Rt, from_frame, filter)
%   LDP_TOP_3rd_hist returns histogram of 3rd-order LDP_TOP
